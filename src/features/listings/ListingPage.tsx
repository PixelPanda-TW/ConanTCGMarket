...
export function ListingPage({ id }: { id: string }) {
  ...
  if (listing === undefined) return <PageShell width="listing" backToMarketplace><p>商品載入中</p></PageShell>;
  if (!listing || listing.status !== 'active') return <PageShell width="listing" backToMarketplace><section className="listing-state"><h1>找不到商品</h1></section></PageShell>;
  ...
  return <PageShell width="listing" backToMarketplace><article className="listing-page">
